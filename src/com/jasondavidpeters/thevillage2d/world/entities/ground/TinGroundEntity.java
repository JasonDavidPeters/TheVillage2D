...
public class TinGroundEntity extends GroundEntity {
	...
	public TinGroundEntity(int itemID, Level level, double x, double y, int aliveTime, Sprite sprite) {
		super(itemID, level, x, y, aliveTime, sprite);
	}

	public TinGroundEntity(int itemID, Level level, double x, double y, int aliveTime, double groundLevel, int dir,
			Sprite sprite) {
